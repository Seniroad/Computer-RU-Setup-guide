...
## ВАЖНО
 ...
 Если вы хотите задать вопрос, поделиться своими исследованиями или добавить разборы других авторов — вы можете сделать это в моём Boosty ([ссылка](https://boosty.to/seniro)) или через телеграм (Seniro_gd). Поскольку я не могу заниматься исследованиями круглосуточно, обновления гайда будут двух типов: разовые — при появлении новой информации, и мелкие коммиты — для правок табуляции и прочих мелких исправлений. 
...
Для обращения или сотрудничества пишите в личные сообщения tg/boosty.
