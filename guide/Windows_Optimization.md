...
- Используйте приведенную ниже команду в качестве примера, чтобы отключить определенную настройку. Если в разделе *[базовая настройка некоторых параметров](#Базовая-настройка-некоторых-параметров)* вы оставили включенными Superfetch/Prefetch, то, скорее всего, вам нужны включенные функции, связанные с префетчингом
