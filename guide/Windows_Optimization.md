...
- Можно удалить устаревшие точки восстановления системы на вкладке ``Защита системы``, набрав ``sysdm.cpl`` в ``Win+R``. Его можно полностью отключить, если вы им не пользуетесь
