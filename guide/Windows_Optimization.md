...
>**⚠**
> Драйвера чипсет intel, которые поставляются Microsoft, не имеют большой разницы с установленными вручную, как минимум на процессорах до 12 поколения, так как там уже появляются E-ядра. При желании можно вручную настроить распределение нагрузки между ядрами вручную.
